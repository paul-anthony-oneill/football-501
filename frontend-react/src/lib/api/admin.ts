...
class AdminApiClient {
  ...
  async bulkCreateAnswers(
    questionId: string,
    data: BulkCreateAnswersRequest
  ): Promise<BulkCreateAnswersResponse> {
    return this.request<BulkCreateAnswersResponse>(
      `/questions/${questionId}/answers/bulk`,
      {
        method: "POST",
        body: JSON.stringify(data),
      }
  ...
  async deleteAnswer(id: string): Promise<void> {
    return this.request<void>(`/answers/${id}`, { method: "DELETE" });
  }
