"""
Trivia 501 Scraping Service - Configuration
"""
...
class Settings(BaseSettings):
    ...
    # Application
    app_name: str = "Trivia 501 Scraping Service"
    ...
    database_url: str = Field(
        default="postgresql://trivia501:dev_password@localhost:5432/trivia501",
        env="DATABASE_URL"
    )
    sql_echo: bool = Field(
        default=False,
    ...
    log_file: str = Field(
        default="/var/log/trivia501-scraper.log",
        env="LOG_FILE"
    )
    ...
    # Invalid Darts Scores (from Trivia 501 game rules)
