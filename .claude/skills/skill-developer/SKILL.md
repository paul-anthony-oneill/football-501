...
**Examples:**
- `spring-boot-dev-guidelines` - Spring Boot/Java 17 backend patterns
- `sveltekit-dev-guidelines` - SvelteKit/Tailwind CSS frontend best practices
- `skill-developer` - Skill system documentation
...
- `.claude/hooks/post-tool-use-tracker.sh` - PostToolUse tracker
